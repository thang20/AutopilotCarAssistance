...
cityscapes_data_path = "dataset/leftImg8bit/train"
cityscapes_meta_path = "dataset/gtFine/train"
...
img_dir = cityscapes_data_path # dataset/leftImg8bit/train
label_dir = cityscapes_meta_path # dataset/gtFine/train
for train_dir in train_dirs:
    print (train_dir)

    train_img_dir_path = img_dir + "/" +train_dir #dataset/leftImg8bit/train + train
    train_label_dir_path = label_dir + "/" + train_dir #dataset/gtFine/train + train
    print(train_img_dir_path)
    print(train_label_dir_path)
    ...
    for file_name in file_names:
        ...
        cv2.imwrite(cityscapes_meta_path + "/" +train_dir +'/' + img_id + ".png", label_img)
        train_label_img_paths.append(cityscapes_meta_path + "/" + train_dir + '/' + img_id + ".png")

img_dir = "dataset/leftImg8bit/val"
label_dir = "dataset/gtFine/val"
for val_dir in val_dirs:
    ...
    for file_name in file_names:
        ...
        cv2.imwrite("dataset/gtFine/val" + "/"+val_dir+"/" + img_id + ".png", label_img)
...
with open('dataset/weight' + "/class_weights.pkl", "wb") as file:
