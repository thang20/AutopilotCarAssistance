...
if __name__ == '__main__':
    ...
    network = DeepLabV3(model_id, project_dir="logs").cuda()

    train_dataset = DatasetTrain(cityscapes_data_path="dataset/leftImg8bit/train",
                                 cityscapes_meta_path="dataset/gtFine/train")


    val_dataset = DatasetVal(cityscapes_data_path="dataset/leftImg8bit/val",
                             cityscapes_meta_path="dataset/gtFine/val")
